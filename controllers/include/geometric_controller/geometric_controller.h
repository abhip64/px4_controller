...
class geometricCtrl
{
  private:
    ...
    Eigen::Vector3d targetPos_, targetVel_, targetAcc_, targetW_, targetJerk_, targetSnap_, targetPos_prev_, targetVel_prev_;
    float slit_ang;
    bool gap_state;
    ...
    double Kpos_x_, Kpos_y_, Kpos_z_, Kvel_x_, Kvel_y_, Kvel_z_, Kr, Kw;
    int controller;
