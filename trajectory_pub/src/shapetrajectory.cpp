...
void shapetrajectory::generatePrimitives(Eigen::Vector3d pos, Eigen::Vector3d vel, Eigen::Vector3d acc, Eigen::Vector3d jerk, Eigen::Vector3d pos_, Eigen::Vector3d vel_, Eigen::Vector3d acc_, Eigen::Vector3d jerk_)
{
...
Eigen::Vector3d shapetrajectory::getW(double time)
{
return Eigen::Vector3d(0,0,0);
}

float shapetrajectory::getslit_ang(double time)
{
